...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-08-2018 a las 17:53:15
...
CREATE TABLE `archivos` (
  `cod_archivo` int(10) NOT NULL,
  `nom_archivo` varchar(80) NOT NULL,
  `cod_tip_archivo` int(10) NOT NULL,
...
CREATE TABLE `perspectivas_generales` (
  `cod_per_general` int(10) NOT NULL,
...
CREATE TABLE `tipos_archivo` (
  ...
  `nom_ext_tip_archivo` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
